...
const Hero = () => {
  return (
    <div className="min-h-screen bg-[url('C:\ProgrammingProject\ReactProject\doctor-patient-portal\src\components\hero\hero-img.jpg')] bg-no-repeat bg-cover relative font-sans">
